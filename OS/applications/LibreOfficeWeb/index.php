...
<input type='image' src="../../applications/<?=$appname;?>/images/menu.png" id="nav_list1" border=0 WIDTH="40" HEIGHT="40" hspace="10" vspace="10"  align="left" /><br><br><br><br>
    ...
    <a href="<?=$actionlink;?>&action=add_new_file_docx"><input type='image' src="../../applications/<?=$appname;?>/none_images/docx.png" onclick="javascript: location.href='<?=$actionlink;?>&action=add_file';" title="[<?=_ADD_FILE?>]" border=0 WIDTH="32" HEIGHT="32" /></a>
    <a href="<?=$actionlink;?>&action=add_new_file_xlsx"><input type='image' src="../../applications/<?=$appname;?>/none_images/xlsx.png" onclick="javascript: location.href='<?=$actionlink;?>&action=add_file';" title="[<?=_ADD_FILE?>]" border=0 WIDTH="32" HEIGHT="32" /></a>
    <a href="<?=$actionlink;?>&action=add_new_file_odg"><input type='image' src="../../applications/<?=$appname;?>/none_images/odg.png" onclick="javascript: location.href='<?=$actionlink;?>&action=add_file';" title="[<?=_ADD_FILE?>]" border=0 WIDTH="32" HEIGHT="32" /></a>
    <a href="<?=$actionlink;?>&action=add_new_file_odb"><input type='image' src="../../applications/<?=$appname;?>/none_images/odb.png" onclick="javascript: location.href='<?=$actionlink;?>&action=add_file';" title="[<?=_ADD_FILE?>]" border=0 WIDTH="32" HEIGHT="32" /></a>
