...
// === main ===
// 20120321 - Adapted to Framework by Daniele Deplano email: deplano.d@gmail.com

addEvent(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'js/lightbox2.05/layout/loading.gif',
		expandimg:'js/lightbox2.05/layout/expand.gif',
		shrinkimg:'js/lightbox2.05/layout/shrink.gif',
		effectimg:'js/lightbox2.05/layout/watermark.png',
		effectpos:{x:-15,y:-15},
		effectclass:'effectable',
		closeimg:'js/lightbox2.05/layout/close.gif'
	});
});
