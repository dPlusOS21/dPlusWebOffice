...
<input type='image' src="../images/system-help.png" onclick="javascript: location.href='index.php?action=help';" title="[Help]" border=0 WIDTH="42" HEIGHT="42" hspace="3" vspace="0" align="left" />
...
//----------------------------------------------------------------------------------------------------------
		...
		height: '800',
                ...
                showToolbar: true,
                altRows: true,
                //exportSettings: {fileName: null}, // se abilitato funziona il bottone di stampa ma non fungono i bottoni di esportazione /////////////////
                ready: function()
                {
                ...
                renderToolbar: function(toolBar)
                {
                    ...
                    var buttonTemplate = "<div style='float: left; padding: 3px; margin: 2px;'><div style='margin: 14px; width: 16px; height: 106px;'></div></div>";
                    ...
                    addButton.jqxButton({cursor: "pointer", enableDefault: false, disabled: true, height: 35, width: 35 });
                    addButton.find('div:first').addClass(toTheme('jqx-icon-plus'));
                    addButton.jqxTooltip({ position: 'bottom', content: "Add"});

                    editButton.jqxButton({ cursor: "pointer", disabled: true, enableDefault: false,  height: 35, width: 35 });
                    editButton.find('div:first').addClass(toTheme('jqx-icon-edit'));
                    editButton.jqxTooltip({ position: 'bottom', content: "Edit"});

                    deleteButton.jqxButton({ cursor: "pointer", disabled: true, enableDefault: false,  height: 35, width: 35 });
                    deleteButton.find('div:first').addClass(toTheme('jqx-icon-delete'));
                    deleteButton.jqxTooltip({ position: 'bottom', content: "Delete"});

                    updateButton.jqxButton({ cursor: "pointer", disabled: true, enableDefault: false,  height: 35, width: 35 });
                    updateButton.find('div:first').addClass(toTheme('jqx-icon-save'));
                    updateButton.jqxTooltip({ position: 'bottom', content: "Save Changes"});

                    cancelButton.jqxButton({ cursor: "pointer", disabled: true, enableDefault: false,  height: 35, width: 35 });
...
<!--        <div style='margin-left: 0px; float: left;'>
      ...
      <div id="treeGrid" style='margin-left: 0px; position:absolute; margin-top: 0px; margin-right: 0px; z-index: 1;' ></div>
    <div id='Menu'>
        <ul>
